...
export default function Footer({
  ...
  madeWith,
  copyright = "© 2024 SaveYourMind, Inc. All rights reserved.",
  bottomLinks = [
  ...
  return (
    <div class="w-full bg-base-200 text-accent">
        ...
        <div class="flex flex-col gap-20 w-full">
          ...
          <div class="flex flex-col gap-4 items-center justify-between lg:flex-row lg:items-center py-8">
            <div class="flex flex-col gap-4 items-center lg:flex-row lg:gap-6">
              ...
              <span class="text-primary-content">{copyright}</span>

              <div class="flex gap-2 justify-between lg:gap-6">
                {bottomLinks?.map((item) => (
                  <a
                    class="text-primary-content hover:text-primary-content/90 duration-150 ease-in"
                    href={item.href}
                    target="_blank"
                  >
                    {item.label}
